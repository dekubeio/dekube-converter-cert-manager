...
cert-manager CRD converter for [helmfile2compose](https://github.com/helmfile2compose/helmfile2compose).
...
- `flatten-internal-urls` — strips FQDNs from compose DNS, which breaks certificate SANs generated by this converter. h2c-manager blocks this combination by default. Override with `--ignore-compatibility-errors cert-manager` if you know what you're doing.
